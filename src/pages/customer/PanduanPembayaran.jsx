...
export default function PanduanPembayaran() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ ...sectionStyle, textAlign: "center", marginBottom: "28px" }}
        >
          ...
          >
            Cara Pembayaran yang Mudah & Aman
          </p>
          <p style={{ ...bodyStyle, color: "#7a5c1e" }}>
            Semua transaksi di BlackGold Cherish diproses oleh admin kami untuk
            keamanan dan keakuratan setiap pesanan.
          </p>
        </div>
          ...
          >
            {BANK_ACCOUNTS.map((acc, i) => (
              ...
              >
                ...
                <p style={{ margin: 0, fontSize: "12px", color: "#9e8a7a" }}>
                  a.n. {acc.atasnama}
                </p>
              </div>
            ))}
        ...
        <div
          style={{
            ...sectionStyle,
            background:
              "linear-gradient(135deg, rgba(184,134,11,0.07), rgba(232,200,98,0.04))",
            border: "1px solid rgba(184,134,11,0.2)",
          }}
        >
          ...
          <ul style={{ ...bodyStyle, paddingLeft: "20px", margin: 0 }}>
            <li>
              Bayar dalam <strong>1×24 jam</strong> setelah pesanan dibuat, atau
        ...
        <div style={{ ...sectionStyle, textAlign: "center" }}>
          <p style={{ ...titleStyle, justifyContent: "center" }}>
            💬 Ada pertanyaan soal pembayaran?
          </p>
          <a
            href="https://wa.me/6285761004981?text=Halo,%20saya%20ingin%20konfirmasi%20pembayaran."
            target="_blank"
